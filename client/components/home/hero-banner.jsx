      ...
      <div className="z-20 relative container px-4 py-32 md:py-40 lg:py-52">
        <div className="flex flex-col items-center justify-center space-y-6 text-center">
          <div className="max-w-3xl space-y-4">
            <h1 className="text-white text-5xl md:text-6xl lg:text-7xl tracking-tighter drop-shadow-md font-bold ">
              {title}
            </h1>
            <p className=" mx-auto max-w-[700px] text-white/80 drop-shadow-sm md:text-xl text-lg">
              {description}
            </p>
          </div>
